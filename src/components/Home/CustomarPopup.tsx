...
import { MdOutlineBloodtype, MdOutlineMail } from "react-icons/md";
...
const CustomarPopup = ({ customar, onClose }: CustomarPopupProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div
        className="relative z-50 w-full max-w-6xl bg-zinc-400 dark:bg-[#463f59] rounded-lg shadow-lg flex flex-col"
      >
        <button
          onClick={onClose}
