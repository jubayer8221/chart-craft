...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[100vh] flex items-center justify-evenly dark:bg-[#191919] px-4 transition-colors duration-300">
      <div className="w-full max-w-md p-8 md:hide transform transition-all duration-300">
        <Image
          alt="image"
      ...
      <div className="w-full h-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-300 hover:shadow-xl">
        <div>
          <h1 className="text-2xl  font-bold text-center text-gray-800 dark:text-white">
            Welcome to
            <span className="text-blue-800 block justify-center text-3xl">
              Chart Crafter
            </span>
          </h1>
        ...
        <div>
          ...
          <div className="flex items-center justify-around">
            <Image alt="line" src="/image/line.png" width={150} height={15} />
            <span className="justify-center text-center">or</span>
            <Image alt="line" src="/image/line.png" width={150} height={15} />
          </div>
