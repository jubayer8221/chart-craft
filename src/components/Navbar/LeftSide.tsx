...
const LeftSide = () => {
  return (
    <div className="md:w-60 bg-white dark:bg-[#000022] h-screen flex-1 fixed border-r dark:border-gray-700 border-zinc-200 hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        ...
        <div className="flex flex-col space-y-2 md:px-6 overflow-y-auto scrollbar-hiden">
      ...
      {item.submenu ? (
        ...
        <Link
          ...
          className={`flex flex-row items-center p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-900 w-full space-x-4 ${
            item.path === pathname ? "bg-zinc-100 dark:bg-gray-900" : ""
          }`}
        >
          {item.icon}
          <span className="font-semibold text-4 flex">{item.title}</span>
